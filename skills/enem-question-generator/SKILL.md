...
8. **Ao gerar PDF, arquivo Word ou material para impressão, siga a anatomia do caderno ENEM.** Leia `references/anatomia_caderno_enem.md` — é um system design obrigatório, extraído da geometria vetorial do PDF oficial do ENEM 2019. Vale para a **versão do aluno**: página 200 × 275 mm, duas colunas de ≈88 mm com fio pontilhado na calha, Arial 10 pt com entrelinha 12,8 pt, texto justificado com recuo de 6 mm na primeira linha, tinta #231F20, "Questão N" em 11 pt bold, título de área em 12 pt bold caixa alta, legendas em 8 pt, letras-opção circuladas e filete pontilhado fechando cada questão. As ilustrações saem coloridas (única divergência autorizada do original). A versão do aluno não leva gabarito, resolução comentada nem comentários das alternativas. A **versão do professor** permanece como sempre foi, sem nenhuma alteração.
