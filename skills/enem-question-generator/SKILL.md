...
1. **Identifique a área e mapeie para a Matriz de Referência.** Abra `references/matriz_referencia.txt` (texto oficial completo e verbatim do INEP) e localize a(s) competência(s) de área e a(s) habilidade(s) (Hxx) que correspondem ao conteúdo/tópico pedido pelo usuário. Nunca invente um código de habilidade — cite sempre o texto oficial.
